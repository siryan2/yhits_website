...
gulp.task("sass", () => {
    return gulp
        .src(dir.source + "assets/scss/**/*.{scss,sass}")
...
gulp.task("copy:assets", () => {
    gulp.src([dir.source + "assets/vendor/*.*"]).pipe(gulp.dest(dir.dest + "assets/vendor"));
     ...
     * Fontawesome
     */
    gulp.src(["node_modules/font-awesome/fonts/*"]).pipe(gulp.dest(dir.dest + "assets/fonts"));

    /**
     * jQuery
     */
    gulp.src(["node_modules/jquery/dist/jquery.min.js"]).pipe(
        gulp.dest(dir.dest + "assets/vendor/")
    );
});

gulp.task("copy:plugins", () => {
    gulp.src([dir.source + "assets/js/prism.js"]).pipe(gulp.dest(dir.dest + "assets/js/"));

    gulp.src(["node_modules/owl.carousel/dist/**/*.*"]).pipe(
        gulp.dest(dir.dest + "assets/plugins/owl-carousel/")
    );

    gulp.src(["node_modules/cookieconsent/build/**/*.*"]).pipe(
        gulp.dest(dir.dest + "assets/plugins/cookieconsent/")
    );

    gulp.src(["node_modules/isotope-layout/dist/isotope.pkgd.min.js"]).pipe(
